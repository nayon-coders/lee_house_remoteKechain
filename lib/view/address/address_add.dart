    ...
    return Container(
      ...
      child: SafeArea(
        child: Scaffold(
                    ...
                    Align(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Center(child: Text("Add this location",
                            style: TextStyle(
                              fontSize: 17,
                              fontWeight: FontWeight.w500,
                              color: Colors.white
          ...
          bottomNavigationBar: AppBackButton(size: MediaQuery.of(context).size, onClick: ()=>Navigator.pop(context, _selectedAddress[0])),
        ),
      ),
    );
  }
